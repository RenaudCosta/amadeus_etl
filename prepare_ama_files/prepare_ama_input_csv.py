...
class AmaFileProcessor:
    ...
    def __init__(self):
        ### INPUT FILES ###
        no_mappings_found_file = os.path.dirname(os.path.abspath("")) +  "/2-prepare_ama_files/in/no_mappings_founds.csv"  # Locations with no mapping found in step process_mappings
